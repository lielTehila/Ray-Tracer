...
//regular
        Camera camera = new Camera(new Point(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
                .setVPSize(200, 200) //
                .setVPDistance(800);
//        Camera camera = new Camera(new Point(-300, 90, 250), new Vector(4,-1,-1), new Vector(0, 1, -1)) //
//                .setVPSize(200, 200) //
//                .setVPDistance(800);
        //close to the mirror
//Camera camera = new Camera(new Point(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
...
//        Geometry triangle1 = new Triangle(new Point(-89,50,50), new Point(-89,50,250), new Point(-89,10,65))
...
//        Geometry lightBlueSphere = new Sphere(new Point(-5, -40, 160), 17d)
//                .setEmission(new Color(new java.awt.Color(28,255,243)))
//                .setMaterial(new Material().setkS(1).setkD(0.5).setKr(0.2));
        Geometry purpleSphere = new Sphere(new Point(20, -42, 230), 8d)
                .setEmission(new Color(197,92,232))
                .setMaterial(new Material().setkD(1));
//        Geometry blueSphere = new Sphere(new Point(40, -30, 300), 20d)
...
//                .setMaterial(new Material().setkD(0.2).setKt(0.6));
        Geometry greenSphere2 = new Sphere(new Point(40, -38, 300), 12d)
                .setEmission(new Color(6,226,138))
                .setMaterial(new Material().setkD(1));
        Geometry pinkSphere2 = new Sphere(new Point(55, -35, 380), 15d)
                .setEmission(new Color(255,127,154))
                .setMaterial(new Material().setkD(1));
        Geometry greenSphere3 = new Sphere(new Point(-50, -35, 1200), 15d)
                .setEmission(new Color(75, 255, 40))
                .setMaterial(new Material().setkD(1));
        Geometry blackSphere2 = new Sphere(new Point(45, -40, 440), 10d)
                .setEmission(new Color(BLACK))
                .setMaterial(new Material().setkD(0.6).setKr(0.4).setkS(1));
        Geometry pinkSphere3 = new Sphere(new Point(28, -42, 490), 8d)
        ...
        scene.getGeometries().add(floor, ceilTri1,ceilTri2, frontWall, besideWallTri1,besideWallTri2, rightWall, trWallR1, trWallR2, trWallL1, trWallL2,
                trDoor1, trDoor2, trUpDoor1, trUpDoor2);
        scene.getGeometries().add(pinkSphere3, blackSphere2,pinkSphere,greenSphere,greenSphere2,pinkSphere2,purpleSphere,orangeSphere,blackSphere,brownSphere, Lamp1, Lamp2, Lamp3, Lamp4, Lamp5, Lamp6);
